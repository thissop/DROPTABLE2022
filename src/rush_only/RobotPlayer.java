...
public strictfp class RobotPlayer {
    ...
    static void runArchon(RobotController rc) throws GameActionException {
        ...
        int num_archons = rc.getArchonCount();
        boolean need_to_build_tower = false;

        if (manufactured_towers<num_archons&&turnCount<200) {
            need_to_build_tower = true;
        }
    ...
    static void runBuilder(RobotController rc) throws GameActionException {
        ...
        int test_dist = 0;
        for (RobotInfo nearby_robot : rc.senseNearbyRobots(20, rc.getTeam())) {
            if (nearby_robot.getType().equals(RobotType.ARCHON)) {
                ...
                if (nearby_robot.getType().equals(RobotType.WATCHTOWER)) {
                    nearby_tower = true;
                }
            }
        }
