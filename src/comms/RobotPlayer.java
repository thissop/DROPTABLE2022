...
public strictfp class RobotPlayer {
    ...
    static void runArchon(RobotController rc) throws GameActionException {
        ...
        else if (manufactured_miners<10) {
            Direction dir = directions[rng.nextInt(directions.length)];
            rc.setIndicatorString("Trying to build a miner");
    ...
    static MapLocation guess_location(RobotController rc, MapLocation reference_location, String guess_type) {
        ...
        return new MapLocation(max_x-ref_x, max_y-ref_y); //temp
    }
    ...
    */
    static void write_archon_locs(RobotController rc) throws GameActionException {
